...
class CalendarNavigation(QWidget):
    ...
    def _update_nav_icons(self) -> None:
        ...
        prev_color = (
            self._style.nav_icon_color if prev_enabled else self._style.muted_day_text_color
        )
        next_color = (
            self._style.nav_icon_color if next_enabled else self._style.muted_day_text_color
        )
        ...
        prev_cursor = (
            Qt.CursorShape.PointingHandCursor if prev_enabled else Qt.CursorShape.ArrowCursor
        )
        next_cursor = (
            Qt.CursorShape.PointingHandCursor if next_enabled else Qt.CursorShape.ArrowCursor
        )
